...
(function() {
  ...
  d3.liquidfillgauge = function(value, settings) {
    ...
    function liquidfillgauge(g) {
      g.each(function(d){
        ...
        var clipArea = d3.svg.area()
            ...
            .y0(function(d) { return waveScaleY(Math.sin(Math.PI*2*config.get("waveOffset")*-1 + Math.PI*2*(1-config.get("waveCount")) + d.y*2*Math.PI));} )
